...
// detect LP32
#if JMSD_SOMEHOW == JSMF_CPP_TRUE

	#define JMSD_MEMORY_MODEL_IS_LP32				JMSD_CPP_TRUE
	#define JMSD_MEMORY_MODEL_LP32_IS_DEFINED		JMSD_CPP_TRUE
...
#else
	#define JMSD_MEMORY_MODEL_LP32_IS_DEFINED		JMSD_CPP_FALSE
