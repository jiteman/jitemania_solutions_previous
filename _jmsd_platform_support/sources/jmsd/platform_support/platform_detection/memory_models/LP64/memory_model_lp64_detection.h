...
#if JMSD_ARCHITECTURE_TYPE == JMSD_ARCHITECTURE_TYPE_AMD64 && defined( JMSD_GNU_CCPP_COMPILER_IS_DETECTED )

	#define JMSD_MEMORY_MODEL_IS_LP64				JMSD_CPP_TRUE
	#define JMSD_MEMORY_MODEL_LP64_IS_DEFINED		JMSD_CPP_TRUE
...
#else
	#define JMSD_MEMORY_MODEL_LP64_IS_DEFINED		JMSD_CPP_FALSE
