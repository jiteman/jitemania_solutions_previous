...
namespace Catch {
    ...
    namespace Detail {
        ...
        JMSD_CATCH_LIBRARY_SHARED_INTERFACE std::unique_ptr<EnumInfo> makeEnumInfo( StringRef enumName, StringRef allValueNames, std::vector<int> const& values );
        ...
        JMSD_CATCH_LIBRARY_SHARED_INTERFACE std::vector<StringRef> parseEnums( StringRef enums );
