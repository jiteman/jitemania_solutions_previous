...
class JMSD_CATCH_LIBRARY_SHARED_INTERFACE GeneratorException : public std::exception {
...
namespace Generators {
    ...
    JMSD_CATCH_LIBRARY_SHARED_INTERFACE auto acquireGeneratorTracker( SourceLineInfo const& lineInfo ) -> IGeneratorTracker&;
