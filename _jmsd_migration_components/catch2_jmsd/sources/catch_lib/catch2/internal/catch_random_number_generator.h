...
namespace Catch {
    ...
    class JMSD_CATCH_LIBRARY_SHARED_INTERFACE SimplePcg32 {
    ...
    private:
        JMSD_CATCH_LIBRARY_SHARED_INTERFACE friend bool operator==(SimplePcg32 const& lhs, SimplePcg32 const& rhs);
        JMSD_CATCH_LIBRARY_SHARED_INTERFACE friend bool operator!=(SimplePcg32 const& lhs, SimplePcg32 const& rhs);
